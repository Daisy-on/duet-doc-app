...
export default function SyncConflictModal({
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center bg-black/30 backdrop-blur-[2px]">
      <div className="w-[460px] max-w-[92vw] rounded-xl border border-border-color bg-bg-main p-5 shadow-xl">
        <div className="flex items-start gap-3">
          <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-amber-50 dark:bg-amber-950 text-amber-600 dark:text-amber-400">
            <AlertTriangle size={17} />
          </div>
          <div className="min-w-0 flex-1">
            <h3 className="text-base font-bold text-text-primary">发现云端版本冲突</h3>
          ...
          <button
            ...
            onClick={onClose}
            className="rounded p-1 text-text-ghost transition-colors hover:bg-hover-bg hover:text-text-primary disabled:opacity-40"
          >
            <X size={16} />
          </button>
        </div>
        ...
        <div className="mt-4 grid gap-2">
          <button
            ...
            className="flex items-center gap-3 rounded-lg border border-border-color bg-bg-panel/40 px-4 py-3 text-left transition-colors hover:border-accent hover:bg-accent/5 disabled:opacity-50"
          >
            ...
            <span>
              <span className="block text-sm font-semibold text-text-primary">保留本地版本</span>
          ...
          >
            ...
            <span>
              <span className="block text-sm font-semibold text-text-primary">采用云端版本</span>
              <span className="mt-0.5 block text-xs text-text-secondary">
                放弃该条尚未同步的本地修改
              </span>
            </span>
        ...
        <div className="mt-4 text-right text-xs text-text-ghost">
