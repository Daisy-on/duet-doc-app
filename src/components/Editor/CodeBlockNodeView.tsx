...
export default function CodeBlockNodeView({ node, updateAttributes }: NodeViewProps) {
  ...
  return (
    ...
    >
      ...
      {!collapsed && (
        <div
          className={`flex items-center justify-between px-3.5 py-1.5 border-b select-none rounded-t-xl ${
            isDark
              ? 'bg-[#2D2D2D] border-[#444] text-[#A0A0A0]'
              : 'bg-[#EAECEF] border-gray-300 text-gray-600'
          }`}
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative" ref={langRef}>
              ...
              {langOpen && (
                <div
                  className={`absolute top-full right-0 mt-1 py-1 w-40 max-h-[280px] overflow-y-auto rounded-lg shadow-xl border z-[60] custom-scrollbar ${
                    isDark
