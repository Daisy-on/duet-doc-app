    ...
    <main className="flex-1 p-10 overflow-y-auto bg-bg-main relative">
      ...
      <div className="grid grid-cols-4 gap-4 mb-10 select-none">
        ...
        >
          ...
          <div className="text-xs text-text-secondary leading-snug">在已有知识库中快速添加新文档</div>
        </div>
        ...
        >
          ...
          <div className="text-[15px] font-semibold text-text-primary mt-1 flex items-center gap-1.5">
            <span>模板中心</span>
            <span className="text-[9px] bg-orange-50 text-orange-600 border border-orange-200 px-1 py-0.5 rounded font-bold">即将上线</span>
          </div>
        ...
        >
          ...
          <div className="text-[15px] font-semibold text-text-primary mt-1 flex items-center gap-1.5">
            <span>AI 帮你写</span>
            <span className="text-[9px] bg-gray-100 text-gray-600 border border-gray-200 px-1 py-0.5 rounded font-bold">即将上线</span>
          </div>
          <div className="text-xs text-text-secondary leading-snug">输入提示词，由 AI 自动生成文档</div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl p-6 border border-border-color shadow-sm">
        ...
        <div className="flex gap-6 border-b border-border-color mb-4 pb-2">
          ...
          <div className="text-sm text-text-secondary cursor-pointer hover:text-text-primary transition-colors pb-2 select-none">浏览过</div>
          <div className="text-sm text-text-secondary cursor-pointer hover:text-text-primary transition-colors pb-2 select-none">邀我协作的</div>
          <div className="text-sm text-text-secondary cursor-pointer hover:text-text-primary transition-colors pb-2 select-none">分享中的</div>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-border-color">
                <th className="text-xs text-text-secondary font-medium py-3 px-2 w-[45%]">文档标题</th>
                <th className="text-xs text-text-secondary font-medium py-3 px-2 w-[35%]">所属知识库 / 所有者</th>
                <th className="text-xs text-text-secondary font-medium py-3 px-2 w-[20%]">最后修改时间</th>
              </tr>
            </thead>
            <tbody>
              {recentDocs.map((doc) => {
